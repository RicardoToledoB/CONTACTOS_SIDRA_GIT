          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="panel-heading"><span class="glyphicon  glyphicon-home" aria-hidden="true"></span> Editar Departamento</div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                           ...
                           <div class="form-group">
                                <label class="control-label" for="codigodepartamentoedit">Codigo Departamento</label>
                                <input type="text" class="form-control" id="codigodepartamentoedit" name="codigodepartamentoedit" placeholder="Codigo Departamento" readonly>
                           </div>
                            <div class="form-group">
                                <label class="control-label" for="nombredepartamentoedit">Nombre Establecimiento</label>
                                <input type="text" class="form-control" id="nombredepartamentoedit" name="nombredepartamentoedit" placeholder="Nombre Departamento">
                           </div>
                           <div class="form-group">
                                <label class="control-label" for="nombreestablecimientoedit">Seleccionar Establecimiento</label>
                                <select class="form-control" id="nombreestablecimientoedit">
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                    <div class="panel panel-primary">
                <div class="panel-heading"><span class="glyphicon  glyphicon-home" aria-hidden="true"></span> Crear Nuevo Departamento</div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombredepartamento" name="nombredepartamento" placeholder="Nombre Departamento">
                           </div>
                            <div class="form-group">
                                <label class="control-label" for="nombreestablecimiento">Seleccion Establecimiento</label>
            ...
            <div class="row">
                        <div class="col-md-12">
                          <div class="panel panel-default">
                            <div class="panel-heading"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Departamento <span class="label label-danger">SSM</span></div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-9">
                                        <button id="add" class="btn btn-primary" type="submit" data-toggle="modal" data-target="#myModal"><span  class="glyphicon glyphicon-plus" aria-hidden="true" ></span> Nuevo Departamento</button>
                                    </div>
                                    <!--<div class="col-md-3">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><span class="glyphicon glyphicon-th-list" ></span> Listado Departamentos</div>
                                ...
                                <table class="table table-striped table-hover footable table-bordered table-condensed" >
                                     <thead>
                                        <tr class="info">
                                          ...
                                          <th data-toggle="true" class="col-md-4">Nombre Departamento</th>
                                          <th data-hide="tablet,phone" class="col-md-3">Nombre Establecimiento</th>
                             ...
                             <div class="panel-footer">Detalle listado Departamentos</div>
    ...
    <script type="text/javascript">
        $(function() {
            //CRUD RICARDO IGNACIO TOLEDO BARRIA //
                ...
                $("#nombreestablecimientoedit").append("<option>ALGO</option>");
                function search(){
                ...
                $("#nombreestablecimientoedit").mouseenter(function(){
                ...
                function show(){
                    ...
                    $.ajax("SrvDepartamentos?show="+"true",{
                            type: "post",   
                            dataType: 'json',
                            contentType: 'application/json',
                            mimeType: 'application/json',
                            success: function(result) {
                              ...
                              console.log("El valor enviado es:", result);
                                ...
                                $.each(result, function( index, value ) {
                                    ...
                                    //<td scope="row" class="col-md-1">'+value.id_departamento+'</td>
                                    $("#miTabla").append('<tr><tr>'+'\n\
                                                                       '+'<td class="col-md-4">'+value.nombre+'</td>'+'\n\
                                                                       '+'<td class="col-md-3">'+value.nuevoEstablecimiento+'</td>'+'\n\
                                                                       '+'<td class="col-md-4"><div class="btn-group" role="group"> <button type="button" class="btn btn-primary view" title="'+value.id_departamento+'" disabled><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>  <button type="button" class="btn btn-success edit" title="'+value.id_departamento+'" data-toggle="modal" data-target=".modalEditar"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></button><button type="button" class="btn btn-danger disabled dell" title="'+value.id_departamento+'" data-toggle="modal" data-target=".bs-example-modal-sm"><span class="glyphicon glyphicon-trash"  aria-hidden="true"></span></button></div></td>\n\
                                                                       '+'</tr></tr>');
                                });
                                //CAPTURAMOS EL ID
                                $('.dell').click(function(){
                                ...
                                $('.btn-Eliminar').click(function(){
                                    console.log(idEliminar);
                                     $.ajax("SrvDepartamentos?eliminar="+idEliminar,{
                                        type: "post",   
                                        dataType: 'json',
                                        //data: $form.serialize(),
                                        contentType: 'application/json',
                                ...
                                $('.edit').click(function(){
                                    ...
                                    $("#codigodepartamentoedit").val(idActualizar);
                                    $.ajax("SrvDepartamentos?editar="+idActualizar,{
                                        type: "post",   
                                        dataType: 'json',
                                        //data: $form.serialize(),
                                        contentType: 'application/json',
                                        ...
                                        success: function(result) {
                                            ...
                                            console.log("Success"+result);
                                             $.each(result, function( index, value ) {
                                                $("#nombredepartamentoedit").val(""+value.nombre);
                                                $("#nombreestablecimientoedit").append('<option value='+value.id_establecimiento+'>'+value.nuevoEstablecimiento+'</option>');
                                             });
                                        },
                                        error: function(result) {
                                          console.error("Errores:"+ result);
                ...
                var validator=$('#establecimientosForm').formValidation({
                        ...
                        nombredepartamento: {
                            ...
                            var $id_establecimiento=$("#nombreestablecimiento").val();
                            $.ajax("SrvDepartamentos?nombredepartamento="+$nombredepartamento+"&nombreestablecimiento="+$id_establecimiento+"&add=true",{
                                type: "post",   
                                dataType: 'json',
                                data: $form.serialize(),
                                contentType: 'application/json',
                ...
                var validator=$('#editarEstablecimiento').formValidation({
                        ...
                        nombredepartamentoedit: {
                            ...
                            fv    = $form.data('usuarioForm');
                            // Use Ajax to submit form data
                            var $id=$("#codigodepartamentoedit").val();
                            var $nombres=$("#nombredepartamentoedit").val();
                            var $id_establecimiento=$("#nombreestablecimientoedit").val();
                            $.ajax("SrvDepartamentos?edit="+$id+"&nombres="+$nombres+"&id_establecimiento="+$id_establecimiento,{
                                type: "post",   
                                dataType: 'json',
                                data: $form.serialize(),
                                contentType: 'application/json',
